# Portefólio profissional de João Santos
...
contra a entrada real do Worker. O workflow em `.github/workflows/ci.yml` repete
estas verificações em cada alteração ao ramo `main` e em pull requests; não faz
